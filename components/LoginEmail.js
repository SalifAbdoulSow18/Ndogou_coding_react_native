    ...
    <View style={{flex: 1, backgroundColor: "#E5E5E5"}}>
      <View style={{alignItems: "center", marginTop: 74}}>
        ...
        <View style={{padding: 10}}>
          ...
          <TouchableOpacity style={{alignItems: "flex-end"}}><Text style={{color:"#001F34", fontSize: 12}}>Mot de passe oublié</Text></TouchableOpacity>
       ...
       <TouchableOpacity onPress={()=>navigation.navigate('LoginPhone')} style={{height: 37, width: "100%", backgroundColor:"#ffff", marginTop:18, justifyContent:"center", alignItems: "center", borderRadius: 7, borderWidth: 1, borderColor: "#11BD9E"}}>
        <Text style={{color:"#001F34",fontSize: 12}}>Se connecter avec un téléphone</Text>
      </TouchableOpacity>
